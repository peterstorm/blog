...
jQuery( function () {
	...
	jQuery( "#address-selector .change-address" ).on( "click", function ( e ) {
		...
		if ( $target.hasClass( "address-list" ) || $parent.hasClass( "address-list" ) ) {
			if ( $target.hasClass( "address-code" ) ) {
				...
				jQuery( "#address-selector .address-container" ).not( "#address-" + $target.data( "address-code" ) ).removeClass( "active" );
				jQuery( "#address-selector #address-" + $target.data( "address-code" ) ).addClass( "active" );
	...
	if ( jQuery.fn.masonry ) {
		...
		console.log("hello from fn.masonry");
	}
